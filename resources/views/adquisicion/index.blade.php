  ...
  <div class="container-fluid">
    <div class="card text-center">
      <div class="card-header">
        <h3 class="float-left">Tipos Adquisiciones</h3>
        <a href="{{url('tiposadquisicion/create')}}" role="button" name="button" class="btn btn-danger col-md-2 float-right">
...
$(document).ready( function () {
  var tabla = $('#table').DataTable({
    ...
    ajax: "{{ url('tiposadquisicion/getdata') }}",
    columns: [
      { data: 'nombre'},
