...
<div class="container mt-3">
    ...
    <div class="card-header">
        <h3 class="float-left">Añadir Ubicación</h3>
        ...
        <div class="card-body">
            ...
            <div class="col-md-12">
                ...
                <input type="text" id="edificio"  name="edificio" value="{{ old('edificio') }}" class="form-control" required>
                <label for="aula">Aula</label>
                <input type="text" id="aula"  name="aula" value="{{ old('aula') }}" class="form-control" required>
