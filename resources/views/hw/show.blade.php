      ...
      <div class="card-body">
        <div class="form-row">
           <div class="form-group col-md-3">
             ...
             <input type="text" id="" name="" value="{{ $bien->noserie }}" class="form-control text-center text-uppercase" placeholder="" required>
           </div>
          <div class="form-group col-md-3">
            <label for="">No serie</label>
            <input type="text" id="" name="" value="{{ $bien->noinventario }}" class="form-control text-center text-uppercase" placeholder="" required>
          </div>
          <div class="form-group col-md-3">
        ...
        <div class="form-row">
           <div class="form-group col-md-3">
             ...
             <input type="text" id="marca" name="marca" value="{{ $responsable->nombre }}" class="form-control text-center text-uppercase" placeholder="" required>
           </div>
          <div class="form-group col-md-3">
            <label for="modelo">Ubicacion</label>
            <input type="text" id="modelo" name="modelo" value="{{ $ubicacion->edificio }}" class="form-control text-center text-uppercase" placeholder="" required>
          </div>
          <div class="form-group col-md-3">
            <label for="marca">Tipo de hardware</label>
            <input type="text" id="marca" name="marca" value="{{ $tiposhardware->nomHardware }}" class="form-control text-center text-uppercase" placeholder="" required>
          </div>
         <div class="form-group col-md-3">
           <label for="modelo">tipo de adquisicion</label>
           <input type="text" id="modelo" name="modelo" value="{{ $tiposadquisicion->nombre }}" class="form-control text-center text-uppercase" placeholder="" required>
         </div>
        </div>{{-- row --}}
        ...
        <div class="form-group row justify-content-center my-4">
          ...
          <div class="col-sm-9">
            <textarea class="form-control" name = "observaciones" id="observaciones" rows="3"> {{ $hardware->observaciones }} </textarea required>
          </div>
        </div>
        <div>
