        ...
        <form>
            ...
            <div class="row py-3 px-5">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <input type="text" id="marca_monitor" class="form-control" disabled readonly>
                    </div>
                    <div class="col-sm-12">
                        <label for="modelo_monitor" class="form-label">Modelo: </label>
                    </div>
                    <div class="col-sm-6">
                        <input type="text" id="modelo_monitor" class="form-control" disabled readonly>
                    </div>
                </div>
                <div class="col-sm-6">
                    <h6>Puertos: </h6>
                    <div class="row row-cols-2">
                        <div class="form-check">
                            <input type="checkbox" id="control" class="form-check-input" disabled readonly>
                            <label for="control">Control remoto</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" id="hdmi" class="form-check-input" disabled readonly>
                            <label for="hdmi">HDMI</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" id="vga" class="form-check-input" disabled readonly>
                            <label for="vga">VGA</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" id="rs232" class="form-check-input" disabled readonly>
                            <label for="rs232">RS232</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" id="audio" class="form-check-input" disabled readonly>
