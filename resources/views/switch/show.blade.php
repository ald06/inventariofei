        ...
        <form>
            ...
            <div class="row py-3 px-5">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" type="text" value="Switch" id="dispo" disabled readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row py-3 px-5">
                ...
                <div class="col-sm-6">
                    <div class="row row-cols-2">
                        <div class="col-sm-12">
                            <label for="puert_ether" class="form-label">Puertos Ethernet: </label>
                        </div>
                        <div class="col-sm-8">
                            <input type="number" id="puert_ether" min="0" max="64" class="form-control" disabled readonly>
                        </div>
                        <div class="col-sm-12">
                            <label for="puert_spf" class="form-label">SPF: </label>
                        </div>
                        <div class="col-sm-8">
                            <input type="number" id="puert_spf" min="0" max="15" class="form-control" disabled readonly>
                        </div>
                    </div>
                </div>
            </div>
