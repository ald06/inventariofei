        ...
        return '
          <div class="btn-group dropleft" data-toggle="tooltip" data-placement="top" title="Acciones">
              ...
              <div class="dropdown-menu">
                <a href="'.route('tiposhardware.edit', $users->id).'" role="button" class="dropdown-item"><i class="fas fa-pencil-alt fa-fw fa-lg text-primary"></i> Editar</a>
                <form action="'.route('tiposhardware.destroy', $users->id).'" method="POST">
